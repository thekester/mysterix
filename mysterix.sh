...
#*************************************************** Objectifs ***************************************************
					...
					# Hacking version clé champignon Windows Linux Mac simulation jouer contre IA sinon IA hacker ordinateur  
							...
							function menuPrincipal
							{
								...
								if (($modeDuJeu==2))
								then
									echo -e "Comment vous appellez vous joueur 2?"
									read nomJoueur2
...
do
	...
	echo -e "Comment voulez vous vous appelez?"
	read nomJoueur1
	menu
	...
	then #Alors
		...
		do #Faire
			...
			do
				...
				then #Alors
					echo -e " $nomJoueur1 : Selon toi, quel est le nombre mystère ?\n" #On affiche à l'écran Joueur 1 : Quel est le nombre ?\n
	...
	then #Alors
		...
		do
				...
				compteurDeCoups=$(($compteurDeCoups+1)) #On incrémente le compteurDeCoups
					...
					then #Alors
               					echo -e "C'est moins !\n\n" #On affiche C'est moins ! à l'écran
                    				...
                    				echo -e "Bravo, $nomJoueur1 vous avez trouvés le nombre mystere en $compteurDeCoups coups !!!\n\n" #On affiche Bravo, vous avez trouve le nombre mystere en  x coups !!!
						echo -e "C'est dommage $nomJoueur2, vous avez perdu avec $compteurDeCoups2 tentatives vous ferez mieux la prochaine fois \n"
						echo -e "$nomJoueur1 à vous de donner la réponse à la question suivante \n"
						partieModeDeJeu2=0
					...
					#echo -e "\n \n CompteurMort : $compteurMort"
 					...
 					#echo -e "compteurDeCoups : $compteurDeCoups \n \n "
                			...
                			then #ALors
                    				echo -e "\t*****************GAME-OVER*****************\n" #On affiche AU-REVOIR quand l'utilisateur quitte le jeu
						echo -e "$nomJoueur1 a perdu avec $compteurDeCoups tentatives \n"
						echo -e "$nomJoueur2  a gagné avec $compteurDeCoups2 tentatives \n"
						echo -e "$nomJoueur2  à vous de donner la réponse à la question suivante \n"
						partieModeDeJeu2=0
				...
				compteurDeCoups2=$(($compteurDeCoups2+1)) #On incrémente compteurDeCoups2
               			if [ $partieModeDeJeu2 -eq 1 ] #Si finDuJeu est différent de 1
               			then #Alors
                    			echo -e " $nomJoueur2 : Selon toi, quel est le nombre mystère ? \n" #On affiche à l'écran Joueur 2 : Quel est le nombre ?
					...
					then #Alors
               					echo -e "C'est moins !\n\n" #On affiche C'est moins ! à l'écran
                    				...
                    				echo -e "Bravo, $nomJoueur2 vous avez trouvés le nombre mystere en $compteurDeCoups coups !!!\n\n" #On affiche Bravo, vous avez trouve le nombre mystere en  x coups !!!
                    				echo -e "C'est dommage $nomJoueur1, vous avez perdu avec $compteurDeCoups2 tenattives vous ferez mieux la prochaine fois \n"
						echo -e "$nomJoueur2 à vous de donner la réponse à la question suivante \n"
						partieModeDeJeu2=0
                			...
                			then # Alors
                    				echo -e "\t*****************GAME-OVER*****************\n" #On affiche AU-REVOIR quand l'utilisateur quitte le jeu
						echo -e "$nomJoueur2 a perdu avec $compteurDeCoups2 tentatives \n"
						echo -e " $nomJoueur1 a gagné avec $compteurDeCoups tentatives \n"
						echo -e " $nomJoueur1 à vous de donner la réponse à la question suivante \n"
						partieModeDeJeu2=0
						nombreEntre=$nombreMystere
					fi #Fin de la condition où le compteurMort est égale au compteurDeCoups
	    	 	...
	    	 	do #Faire
					...
					#echo -e "\n \n CompteurMort : $compteurMort"
 					#echo -e "compteurDeCoups : $compteurDeCoups \n \n "
               		 		...
               		 		then #alors
                   		 		echo -e "\t*****************GAME-OVER*****************\n" #On affiche AU-REVOIR quand l'utilisateur quitte le jeu
						echo -e "$nomJoueur1a perdu avec $compteurDeCoups tentatives \n"
						echo -e "IA a gagné avec $compteurDeCoups2 tentatives \n"
						echo -e "IA à vous de donner la réponse à la question suivante \n"
						echo -e "Non je préfère que ce soit $nomJoueur1 qui choisisse \n"
						echo -e "Comme tu voudras IA $nomJoueur1 à vous de répondre à cette question \n"
                    				partieModeDeJeu3=0
						nombreEntre2=$nombreMystere2
						break;
				...
				compteurDeCoups2=$(($compteurDeCoups2+1)) #On incrémente compteurDeCoups2
					...
					#echo -e " Nombre entre 2 : $nombreEntre2 \n "
						...
						echo -e "Bravo, IA vous avez trouvés le nombre mystere en $compteurDeCoups coups !!!\n\n" #On affiche Bravo, vous avez trouve le nombre mystere en  x coups !!!
                    				echo -e "C'est dommage $nomJoueur1, vous avez perdu avec $compteurDeCoups2 tentatives vous ferez mieux la prochaine fois \n"
						echo -e "IA à vous de donner la réponse à la question suivante \n"
						echo -e "Non je préfère que ce soit $nomJoueur1 qui choisisse \n"
						echo -e "Comme tu voudras IA $nomJoueur1 à vous de répondre à cette question \n"
						partieModeDeJeu3=0
